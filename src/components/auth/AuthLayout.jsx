      ...
      <div className="flex-1 flex items-center justify-center bg-black px-4 py-4">
        <div className="w-full max-w-md animate-slide-up">
          <div className="lg:hidden flex items-center justify-center gap-3 mb-5">
            ...
            <span className="text-xl font-bold text-white">VerifAI</span>
          </div>

          <div className="bg-gray-950 border border-gray-800 rounded-2xl shadow-2xl shadow-yellow-500/5 p-6">
            {children}
          </div>
