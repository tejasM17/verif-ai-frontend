    ...
    <div className="relative mb-5 animate-fade-in">
      ...
      >
        <input
          ...
          className={`
            peer block w-full bg-transparent px-4 pt-5 pb-2
        ...
        <label
          className={`
            ...
            ${value || focused
              ? "top-1.5 text-xs font-medium text-yellow-400"
      ...
      {error && (
        <p className="mt-1.5 text-xs text-red-400 flex items-center gap-1 animate-shake">
